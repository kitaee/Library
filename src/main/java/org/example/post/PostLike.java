...
public class PostLike {
    ...
    public void create(Long postId, Long userId) {
        ...
        try {
            String sql = String.format("INSERT INTO post_like (post_id, user_id) " +
    ...
    public void readByPostId(Long postId) {
        ...
        PreparedStatement ps = null;
        try {
            String sql = String.format("SELECT * FROM post_like WHERE post_id = %d", postId);
    ...
    public void delete(Long postId, Long userId) {
        PreparedStatement ps = null;
        try {
            String sql = String.format("DELETE FROM post_like WHERE post_id = %d AND user_id = %d", postId, userId);
